<div class="modal fade" id="addAlumniModal" tabindex="-1" role="form" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Tambah Data Alumni Baru</h4>
                </div>
                <div class="modal-body">

                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/alumni/add') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('unitkerja_diklat') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Jabatan saat mengikuti Diklat</label>
