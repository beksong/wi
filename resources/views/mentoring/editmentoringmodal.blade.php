<div class="modal fade" id="editMentoringModal" tabindex="-1" role="form" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/mentoring/edit') }}">
                        {!! csrf_field() !!}
