<div class="modal fade" id="delmquesioner" tabindex="-1" role="form" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/mquesioner/del') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('diklat') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <select id="diklat" name="diklat" class="form-control" readonly>
                        ...
                        <div class="form-group{{ $errors->has('questionfor') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <select id="questionfor" name="questionfor" class="form-control" readonly>
